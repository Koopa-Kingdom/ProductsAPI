...
test('returns product from get req', () => axios.get('http://localhost:3000/api/fec2/hr-rfc/products/1').then((res) => expect(res.data)
  .toEqual({
    id: 1,
    name: 'Camo Onesie',
...
test('returns products from get request', () => axios.get('http://localhost:3000/api/fec2/hr-rfc/products/?page=1&count=4').then((res) => expect(res.data)
  .toEqual(
    [
      {
        id: 1,
...
test('returns styles from get request', () => axios.get('http://localhost:3000/api/fec2/hr-rfc/products/1/styles').then((res) => expect(res.data)
  .toEqual({
    "product_id": 1,
    "results": [
        {
...
test('returns relatedItems from get Request', () => axios.get('http://3.144.175.0/api/fec2/hr-rfc/products/1/related').then((res) => expect(res.data)
  .toEqual(
    [
      2,
      3,
